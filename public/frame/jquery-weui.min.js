...
function(t, e, n, i) {
	...
	t.modal = function(n, i) {
	...
	}, t.prompt = function(n, i, a, r, o, type) {
		var s;
		...
		var c = t.modal({
			text: '<p class="weui-prompt-text">' + (s.text || "") + '</p><input type="' + s.type + '" class="weui_input weui-prompt-input" id="weui-prompt-input" value="' + (s.input || "") + '" />',
			title: s.title,
			autoClose: !1,
			buttons: [{
				text: e.buttonCancel,
	...
	var e = function(e) {
		...
		var c = this,
			l = {
				...
				toolbarCloseText: "完成",
				title: "请选择",
				toolbarTemplate: '<div class="toolbar">          <div class="toolbar-inner">          <a href="javascript:;" class="picker-button close-picker main_color">{{closeText}}</a>          <h1 class="title">{{title}}</h1>          </div>          </div>'
			};
		e = e || {};
